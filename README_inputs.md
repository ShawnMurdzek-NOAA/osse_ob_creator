...
- auto_reg_parm: Autoregression parameter for an AR1 process. $Error = N(0, stdev) + auto_reg_parm * \frac{previous error}{d}$, where stdev is specified in `errtable` and d is the distance between two consecutive observations.
